export const constantText = {
  ...
  FIRST_NAME_VALIDATION_MESSAGE:
    "First name must be of minimum length 8 characters",
  COMPANY_NAME_VALIDATION_MESSAGE:
    "Company name must be of minimum length 8 characters",
  LAST_NAME_VALIDATION_MESSAGE:
    "Last name must be of minimum length 8 characters",
